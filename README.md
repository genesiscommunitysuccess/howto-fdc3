...
Ensure the Genesis Services and Web Application are running and healthy before you proceed to the next steps. Follow the steps on [Quick Start](https://learn.genesis.global/docs/getting-started/quick-start/run-the-application/) for more details.
